...
import com.System.Dispositivo.models.PInfo;
import com.System.Dispositivo.utils.CommonUtilities;
...
public class ApplicationManager 
{
	...
	public ArrayList<PInfo> getInstalledApps(boolean getSysPackages)
	{
		...
		for (int i = 0; i < packs.size(); i++)
		{
			...
			{
				newInfo.tipo = "Sistema";
			}
			else
			{
				newInfo.tipo = "Aplicacion";
			}
			
			Logg.info("Aplicacion: Appname=" + newInfo.appname + ", Pname=" + newInfo.pname + ", VersionName=" + newInfo.versionName + ", VersionCode" + newInfo.versionCode);
