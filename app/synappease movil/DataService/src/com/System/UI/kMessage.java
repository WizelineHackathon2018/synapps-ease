...
public class kMessage extends DialogFragment implements TimePickerDialog.OnTimeSetListener, DatePickerDialog.OnDateSetListener 
{
	...
	private int MsgType; 
	private int id; 
	private kIMessage myListener;
	
	public static final int DLG_FECHA = 0;
	public static final int DLG_HORA = 1;
	public static final int DLG_MSG = 2;

	public kMessage(String titulo, int dia, int mes, int anio, int hora, int minuto, int MsgType, int id, kIMessage m)
	{
		super();
		this.titulo = titulo;
		this.dia = dia;
	...
	public kMessage(String titulo, int dia, int mes, int anio, int MsgType, int id, kIMessage m)
	{
		super();
		this.titulo = titulo;
		this.dia = dia;
	...
	public kMessage(String titulo, int hora, int minuto, int MsgType, int id, kIMessage m)
	{
		super();
		this.titulo = titulo;
		this.dia = dia;
	...
	public kMessage(String titulo, int MsgType, int id, kIMessage m)
	{
		super();
		this.titulo = titulo;
